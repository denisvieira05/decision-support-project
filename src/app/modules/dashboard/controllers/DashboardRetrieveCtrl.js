(function () {
    'use strict';
    angular.module('proint2.dashboard').controller('DashboardRetrieveCtrl', DashboardRetrieveCtrl);

    DashboardRetrieveCtrl.$inject = ['$scope', '$rootScope', '$location', 'APP_SETTINGS','$stateParams'];

    function DashboardRetrieveCtrl($scope, $rootScope, $location, APP_SETTING,$stateParams) {
